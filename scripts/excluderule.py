...
def mapping(a):
   ...
   if a == '(S\S)':
      ...
      return '(S[dcl]\NP)/PP'
   elif a == '((S[adj]\NP)\((S[adj]\NP)/NP))':
      return '(S[adj]\NP)\((S[adj]\NP)/NP)'
   elif a == '(((S[adj]\NP)\((S[adj]\NP)/NP))\((S[adj]\NP)\((S[adj]\NP)/NP)))':
      return '((S[adj]\NP)\((S[adj]\NP)/NP))\((S[adj]\NP)\((S[adj]\NP)/NP))'
   elif a == '(((S\NP)\((S\NP)/PP))\((S\NP)\((S\NP)/PP)))':
      return '((S\NP)\((S\NP)/PP))\((S\NP)\((S\NP)/PP))'
   elif a == '(N/S[em])':
      return 'N/S[em]'
   else:
      return a  
...
def contains(set1, tuple2):
   ...
   def enumeratetuple(tuple2):
      retval = []
      d = {'NP[conj]' : ['NP\NP'], 'S[pss]\NP[conj]' : ['(S[pss]\NP)\(S[pss]\NP)'], 'S[dcl][conj]' : ['S[dcl]\S[dcl]'], '(S\NP)\(S\NP)[conj]' : ['((S\NP)\(S\NP))\((S\NP)\(S\NP))'], 'S[dcl]\NP[conj]' : ['(S[dcl]\NP)\(S[dcl]\NP)'], '(S\NP)\((S\NP)/(S[adj]\NP))[conj]' : ['(((S\NP)\((S\NP)/(S[adj]\NP)))\((S\NP)\((S\NP)/(S[adj]\NP))))'], 'S[adj]\NP[conj]' : ['(S[adj]\NP)\(S[adj]\NP)'], 'S[dcl]\NP[conj]' : ['(S[dcl]\NP)\(S[dcl]\NP)'], 'S[intj][conj]' : ['S[intj]\S[intj]'], 'S[ng]\NP[conj]' : ['(S[ng]\NP)\(S[ng]\NP)'], 'S[b]\NP[conj]' : ['(S[b]\NP)\(S[b]\NP)'], '(S[adj]\NP)/NP[conj]' : ['((S[adj]\NP)/NP)\((S[adj]\NP)/NP)'], 'PP[conj]' : ['PP\PP'], 'S[conj]' : ['S\S'], '(S[adj]\NP)\((S[adj]\NP)/NP)[conj]' : ['((S[adj]\NP)\((S[adj]\NP)/NP))\((S[adj]\NP)\((S[adj]\NP)/NP))'], '(S\NP)\((S\NP)/PP)[conj]' : ['((S\NP)\((S\NP)/PP))\((S\NP)\((S\NP)/PP))']}
#'NP\NP' : ['NP[conj]'], 
